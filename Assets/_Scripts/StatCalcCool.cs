...
public class StatCalcCool : MonoBehaviour {
    ...
    void Update()
    {
        ...
        text.text = (cool.stature.getStature() / sum) * UIL + "%";
        rt.sizeDelta = new Vector2((cool.stature.getStature() / sum) * UIL, rt.rect.height);
