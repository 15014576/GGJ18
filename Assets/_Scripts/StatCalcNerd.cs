...
public class StatCalcNerd : MonoBehaviour {
    ...
    void Update()
    {
        ...
        text.text = (nerd.stature.getStature() / sum) * UIL + "%";
        rt.sizeDelta = new Vector2((nerd.stature.getStature() / sum) * UIL, rt.rect.height);
