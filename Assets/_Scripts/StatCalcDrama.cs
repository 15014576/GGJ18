...
public class StatCalcDrama : MonoBehaviour {
    ...
    void Update()
    {
        ...
        text.text = (drama.stature.getStature() / sum) * UIL + "%";
        rt.sizeDelta = new Vector2((drama.stature.getStature() / sum) * UIL, rt.rect.height);
